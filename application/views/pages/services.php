<section class="services">
	...
	<section class="quad-block">
		<div class="img-wrapper">
			<!--img src="/assets/img/sophie.jpg" alt="Sophie" /-->
		</div>
		<div class="img-wrapper">
			<!--img src="/assets/img/retriever.jpg" alt="Retriever" /-->
		</div>
		<div class="img-wrapper">
			<!--img src="/assets/img/lab.jpg" alt="Lab" /-->
		</div>
		<div class="img-wrapper">
			<!--img src="/assets/img/little_dog.jpg" alt="Little dog" /-->
		</div>
	</section>
	...
	<h3>Pets on the Move</h3>
	<p>The Nanny has experience with and can provide travel preparations for regional, cross-country or even international travel for your pets.  This can include preparing for air travel and compliance with state or country pet transport regulations such as vaccines and obtaining veterinary documentation.  In unique cases, the Nanny’s family can provide transportation services, based on availability.</p>
